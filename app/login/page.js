...
const AdminLoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative">
      ...
      <h1 className='absolute text-[21vw]  sm:text-[25] md:text-[20] font-extrabold text-white/15 select-none pointer-events-none leading-none'>NATURE</h1>
      ...
      >
        ...
        <input
          ...
          />
        <span onClick={() => setShowPassword(!showPassword)} className="absolute right-3 top-1/2 -translate-y-1/2 cursor-pointer text-gray-400 hover:text-white">{showPassword ? <FaEyeSlash /> : <FaEye />}</span>
